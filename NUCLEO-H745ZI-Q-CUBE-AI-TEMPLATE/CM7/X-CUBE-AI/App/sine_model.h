...
#define AI_SINE_MODEL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 16, 1, 2, 1, NULL), \
}
...
#define AI_SINE_MODEL_IN_1_HEIGHT      (16)
#define AI_SINE_MODEL_IN_1_CHANNEL     (2)
#define AI_SINE_MODEL_IN_1_SIZE        (16 *  2)
